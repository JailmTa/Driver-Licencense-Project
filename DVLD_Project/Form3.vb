...
Namespace DVLD_Project
    Public Partial Class Form3
        ...
        Public Sub New(NetionalNo As String)
            ...
            Dim dt = clsBussnesLayer.FindWithFilters(0, "NationalNo", NetionalNo)
            If dt IsNot Nothing Then
                For Each dr As DataRow In dt.Rows
                    lblPersonID.Text = dr(0).ToString()
                    tbNationalID.Text = dr(1).ToString()
        ...
        Private Sub tbNationalID_TextChanged(sender As Object, e As EventArgs)

        End Sub

        Private Sub tbNationalID_Validating(sender As Object, e As CancelEventArgs)
            If True Then
            Else
        ...
        Private Sub rbMale_Click(sender As Object, e As EventArgs)
            pbProfile.Image = Resources.icons8_male_64
        End Sub
